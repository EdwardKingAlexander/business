    ...
    <header class="absolute inset-x-0 top-0 z-50">
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          <Link href="#" class="text-sm font-semibold leading-6 text-white">Home</Link>
          <Link href="#" class="text-sm font-semibold leading-6 text-white">Portfolio</Link>
          <Link href="#" class="text-sm font-semibold leading-6 text-white">About Us</Link>
          <Link href="#" class="text-sm font-semibold leading-6 text-white">Contact</Link>
          <Link href="#" class="text-sm font-semibold leading-6 text-white">Partners</Link>

        </div>
        <div v-if="canLogin" class="hidden lg:flex lg:flex-1 lg:justify-end">

          <Link :href="route('login')" class="text-sm font-semibold leading-6 text-white">
          Log in
    ...
    <main>
          ...
          <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
              <div
                ...
                Discover our open positions. <a href="#" class="font-semibold text-white"><span class="absolute inset-0"
                    aria-hidden="true"></span>Explore<span aria-hidden="true">&rarr;</span></a>
              </div>
            </div>
            <div class="text-center">
              <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Empower Your Business with Responsive
                and Scalable Web Solutions.</h1>
              <p class="mt-6 text-lg leading-8 text-gray-300">Adaptable Websites for an Ever-Changing Digital Landscape.
              </p>
              <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="#"
                  ...
                  started</a>
                <a href="#" class="text-sm font-semibold leading-6 text-white">See more <span
          ...
          <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
            <figure class="relative isolate pt-6 sm:pt-12">
              ...
              <blockquote class="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                <p>Gravida quam mi erat tortor neque molestie. Auctor aliquet at porttitor a enim nunc suscipit tincidunt
      ...
      <div class="relative isolate mt-32 bg-white px-6 sm:mt-56 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center lg:max-w-4xl">
          ...
          <p class="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">The right price for you, whoever you
            are</p>
        </div>
        <p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">Qui iusto aut est earum eos quae.
          Eligendi est at nam aliquid ad quo reprehenderit in aliquid fugiat dolorum voluptatibus.</p>
        <div
