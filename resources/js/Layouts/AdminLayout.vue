...
<template>
  <div>
    <div class="min-h-full">
      ...
      <div v-show="showSidebar" class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
        <!--
    ...
    -->
        ...
        Leaving: "transition ease-in-out duration-300 transform"
          ...
          To: "-translate-x-full"
      -->
          <div class="relative flex w-full max-w-xs flex-1 flex-col bg-red-700 pb-4 pt-5">
            <!--
        ...
        -->
            ...
            <nav class="mt-5 h-full flex-shrink-0 divide-y divide-red-800 overflow-y-auto" aria-label="Sidebar">
              <div class="space-y-1 px-2">
                <!-- Current: "bg-red-800 text-white", Default: "text-red-100 hover:bg-red-600 hover:text-white" -->
                <a href="#"
                  class="bg-red-800 text-white group flex items-center rounded-md px-2 py-2 text-base font-medium"
                  aria-current="page">
                ...
                <a href="#"
                  class="text-red-100 hover:bg-red-600 hover:text-white group flex items-center rounded-md px-2 py-2 text-base font-medium">
                  <svg class="mr-4 h-6 w-6 flex-shrink-0 text-red-200" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round"
              ...
              <div class="mt-6 pt-6">
                <div class="space-y-1 px-2">
                  <a href="#"
                    class="group flex items-center rounded-md px-2 py-2 text-base font-medium text-red-100 hover:bg-red-600 hover:text-white">
